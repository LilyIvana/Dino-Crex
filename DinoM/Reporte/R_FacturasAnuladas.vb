...
Public Class R_FacturasAnuladas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_FacturasAnuladas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_FacturasAnuladas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_FacturasAnuladas = New R_FacturasAnuladas()
        rpt.Site = Me.Site
        Return rpt
    End Function

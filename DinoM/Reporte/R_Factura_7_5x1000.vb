...
Public Class R_Factura_7_5x1000
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_Factura_7_5x1000.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Factura_7_5x1000
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Factura_7_5x1000 = New R_Factura_7_5x1000()
        rpt.Site = Me.Site
        Return rpt
    End Function

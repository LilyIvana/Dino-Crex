...
Public Class R_StockDiferencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_StockDiferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_StockDiferencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_StockDiferencia = New R_StockDiferencia()
        rpt.Site = Me.Site
        Return rpt
    End Function

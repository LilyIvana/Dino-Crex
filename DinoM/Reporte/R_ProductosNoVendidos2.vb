...
Public Class R_ProductosNoVendidos2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_ProductosNoVendidos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_ProductosNoVendidos2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_conteo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_ProductosNoVendidos2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ProductosNoVendidos2 = New R_ProductosNoVendidos2()
        rpt.Site = Me.Site
        Return rpt
    End Function

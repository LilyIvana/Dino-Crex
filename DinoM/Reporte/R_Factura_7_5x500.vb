...
Public Class R_Factura_7_5x500
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_Factura_7_5x500.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Factura_7_5x500
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Factura_7_5x500 = New R_Factura_7_5x500()
        rpt.Site = Me.Site
        Return rpt
    End Function

        ...
        If dt.Rows.Count > 0 Then
            ...
            If swTipo.Value = True Then
                ...
                With JGrM_Buscador.RootTable.Columns("IdVenta")
                    .Width = 100
                    .Caption = "ID VALE/VENTA"
                    .Visible = True
                End With
                With JGrM_Buscador.RootTable.Columns("IdMov")
                    .Width = 100
                    .Caption = "ID MOVIMIENTO"
                    .Visible = True
                End With
                With JGrM_Buscador.RootTable.Columns("NombEmp")
                    .Width = 150
                    .Caption = "NOMBRE EMPRESA"
                    .Visible = True
                End With
                With JGrM_Buscador.RootTable.Columns("NroVales")
                    .Width = 100
                    .Caption = "NRO. VALES"
                    .Visible = True
                End With
                With JGrM_Buscador.RootTable.Columns("CantVales")
                    .Width = 100
                    .Caption = "CANTIDAD VALES"
                    .Visible = True
                End With
                ...
                With JGrM_Buscador.RootTable.Columns("Total")
                    ...
                    .AggregateFunction = AggregateFunction.Sum
                End With
                With JGrM_Buscador.RootTable.Columns("Excedente")
                    .Width = 150
                    .Caption = "EXCEDENTE"
                    .Visible = True
                    .FormatString = "0.00"
                    ...
                    .AggregateFunction = AggregateFunction.Sum
                End With
                With JGrM_Buscador.RootTable.Columns("Beneficio")
                    .Width = 150
                    .Caption = "BENEFICIO"
                    .Visible = True
                    .FormatString = "0.00"
            ...
            Else
                ...
                With JGrM_Buscador.RootTable.Columns("Beneficio")
                    ...
                    .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
                End With
                With JGrM_Buscador.RootTable.Columns("CodDyn")
                    .Width = 100
                    .Caption = "COD. DYNASYS"
                    .Visible = False
                End With

...
Public Class F1_ProductosVales
    ...
    Private Sub _prCargarProductos()
        ...
        If dt.Rows.Count > 0 Then
            ...
            With JGrM_Buscador.RootTable.Columns("yfcdprod1")
                ...
                .Caption = "PRODUCTOS"
            End With
            With JGrM_Buscador.RootTable.Columns("cant")
                .Width = 100
                .Visible = True
                .Caption = "CANTIDAD"
                .FormatString = "0.00"
    ...
    Public Function P_ExportarExcel(_ruta As String) As Boolean
        ...
        If (1 = 1) Then 'If(_directorio.ShowDialog = Windows.Forms.DialogResult.OK) Then
            ...
            Try
                ...
                Dim _archivo As String = _ubicacion & "\ProductosVales_" & Now.Date.Day &
    ...
    Private Sub btnExportarExcel_Click(sender As Object, e As EventArgs) Handles btnExportarExcel.Click
        ...
        If (P_ExportarExcel(RutaGlobal + "\Reporte\Reporte Productos")) Then
            ToastNotification.Show(Me, "EXPORTACIÓN DE PRODUCTOS CON VALES EXITOSA..!!!",
                                       ...
                                       eToastPosition.BottomCenter)
        Else
            ToastNotification.Show(Me, "FALLÓ LA EXPORTACIÓN DE PRODUCTOS CON VALES..!!!",
                                       My.Resources.WARNING, 2000,
                                       eToastGlowColor.Red,
                                       eToastPosition.BottomLeft)
        End If

...
Public Class F0_KardexMovimientoProdxPeso
    ...
    Public Sub _prInterpretarDatosLotes()
        If ((Lote = False) Or (Lote = True And tblote.Text.Length <= 0)) Then
            ...
            If (tbCodigo.Text.Length > 0 And cbAlmacen.SelectedIndex >= 0) Then
                Dt2KardexTotal = L_fnObtenerHistorialProductoGeneralTI003(tbCodigo.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value)
                Dt1Kardex = L_fnObtenerHistorialProductoTI003(tbCodigo.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value)
                ...
                End If
            Else
                Dt1Kardex = L_fnObtenerHistorialProductoTI003("-1", tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value)
            End If
        Else
            If ((Lote = True And tblote.Text.Length > 0)) Then
                If (tbCodigo.Text.Length > 0 And cbAlmacen.SelectedIndex >= 0 And tblote.Text.Length > 0) Then
                    Dt2KardexTotal = L_fnObtenerHistorialProductoGeneralPorLoteTI003(tbCodigo.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value,
                                        tblote.Text, tbFechaVenc.Text)
                    Dt1Kardex = L_fnObtenerHistorialProductoporLoteTI003(tbCodigo.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value, tblote.Text, tbFechaVenc.Text)
                    If (Dt1Kardex.Rows.Count > 0) Then
                        P_ArmarKardex()
                    Else
                        ToastNotification.Show(Me, "No hay kardex para el rango de fecha".ToUpper,
                    ...
                    End If
                Else
                    Dt1Kardex = L_fnObtenerHistorialProductoporLoteTI003("-1", tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"), cbAlmacen.Value, tblote.Text, tbFechaVenc.Text)
                End If
            End If
        End If

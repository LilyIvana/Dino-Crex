...
Partial Class P_Principal
    ...
    Private Sub InitializeComponent()
        ...
        Me.btConfDescuentosCajeros.TitleText = "DESCUENTOS CAJEROS"
        '
        'P_Principal
        '

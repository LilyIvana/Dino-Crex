...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelo.Celda)
        ...
        listEstCeldas.Add(New Modelo.Celda("yfcampo1", True, "Rotación".ToUpper, 100))
        ...
        listEstCeldas.Add(New Modelo.Celda("yfvsup", True, "Conversión DS-UN".ToUpper, 100, Format("0.00")))

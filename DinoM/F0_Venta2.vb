    ...
    Private Sub tbCliente_KeyDown(sender As Object, e As KeyEventArgs) Handles tbCliente.KeyDown
        If (_fnAccesible()) Then
            If e.KeyData = Keys.Control + Keys.Enter Then
                ...
                dt = L_fnListarClientesVentaPrecioWholesaleEspecialPDV()
...
salirIf:
            ...
            End If
            If (e.KeyData = Keys.Control + Keys.S) Then
                ''Arreglo porque se esta yendo al enter de la grilla y no así al MontoBs por eso le hago focus y nuevamente select
                tbMontoBs.Select()
                tbMontoBs.Focus()
                tbMontoBs.Select()
            End If
    ...
    Public Function Emisor(tokenObtenido)
        ...
        Emenvio.email = email
        Emenvio.actividadEconomica = actEconomica 'Actividad económica parametrizada desde tabla ParametrosFact
